...
function changeColor(nameColor) {
    ...
    m.src = `C:\Users\Admin\OneDrive\Lập trình Web 2020\Beginer\B1(cân nặng+đổi tiền+điện thoại)/${nameColor}1.jpg`;

    let images = document.querySelectorAll(".thumb img");
    images.forEach(function(value, index) {
        value.src = `C:\Users\Admin\OneDrive\Lập trình Web 2020\Beginer\B1(cân nặng+đổi tiền+điện thoại)/${nameColor}${index + 1}.jpg`;
    });
}